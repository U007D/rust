    ...
    if options.enable_index_page {
        if let Some(index_page) = options.index_page.clone() {
            ...
            let page = layout::Page {
                ...
                css_class: "mod",
                root_path: "./",
                static_root_path: cx.shared.static_root_path.as_ref_deref(),
...
impl<'a> SourceCollector<'a> {
    ...
    fn emit_source(&mut self, filename: &FileName) -> io::Result<()> {
        ...
        let page = layout::Page {
            ...
            css_class: "source",
            root_path: &root_path,
            static_root_path: self.scx.static_root_path.as_ref_deref(),
            description: &desc,
            keywords: BASIC_KEYWORDS,
...
impl Context {
    ...
    fn krate(self, mut krate: clean::Crate) -> Result<(), Error> {
        ...
        let mut page = layout::Page {
            ...
            css_class: "mod",
            root_path: "../",
            static_root_path: self.shared.static_root_path.as_ref_deref(),
